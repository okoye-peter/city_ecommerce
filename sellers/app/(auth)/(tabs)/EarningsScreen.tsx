...
const EarningsScreen = () => {
    ...
    // iOS-only: temp date held while picker modal is open
    ...
    // Android: native dialog — onValueChange fires on confirm, onDismiss on cancel.
    // iOS: spinner in modal — onValueChange updates tempDate as spinner scrolls; confirmed via Done.
    ...
    const renderHeader = () => (
        <View>
            ...
            <View className="px-6 pt-6 pb-3">
                ...
                {/* Android inline picker (renders as native dialog) */}
